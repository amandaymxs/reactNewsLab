...
import { Grid, Avatar, MuiThemeProvider, Button, Typography, withStyles } from '@material-ui/core';
    ...
    render() {
        ...
        return (
            <MuiThemeProvider theme={theme}>
                {data.map((tweet) => {
                    return (
                        <Grid container direction="row" classes={{ root: classes.tweetsContainer }}>
